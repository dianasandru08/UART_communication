...
set_property PACKAGE_PIN B18 [get_ports RxS]
set_property IOSTANDARD LVCMOS33 [get_ports RxS]
#Bank = 16, Pin name = ,					Sch name = UART_RXD_OUT
set_property PACKAGE_PIN A18 [get_ports TxS]
set_property IOSTANDARD LVCMOS33 [get_ports TxS]
