...
HD_PWD='C:/Users/diana/Desktop/SSC2/incercProiectNou/incercProiectNou.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log modPrin.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source modPrin.tcl -notrace
