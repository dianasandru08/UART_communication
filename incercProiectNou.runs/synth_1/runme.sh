...
HD_PWD='C:/Users/diana/Desktop/SSC2/incercProiectNou/incercProiectNou.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log modPrin.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source modPrin.tcl
